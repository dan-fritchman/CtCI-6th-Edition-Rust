...
# (Rust! Porting in Progress) Solutions to *Cracking the Coding Interview, 6th Edition*

In-progress construction of Rust-language solutions to *Cracking the Coding Interview, 6th Edition*.  
This repository's structure and naming conventions are adapted from the @careercup Python solutions available at 
https://github.com/careercup/CtCI-6th-Edition-Python

Rust code is all written from scratch. 
